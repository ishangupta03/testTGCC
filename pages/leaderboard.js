      ...
      >
        <div className="items-center justify-center">
          <div className="font-sans text-center text-2xl font-extrabold">
            <div className="text-black dark:text-white text-4xl text center font-extrabold mb-10 underline underline-offset-4 decoration-primary_green-0">
              <span className="text-primary_green-0"> GSSoC 2023 </span>
              Top Performers
            </div>
          </div>
        </div>
                ...
                {totalData[1] !== undefined && (
                  <>
                    ...
                    <FontAwesomeIcon
                      ...
                      size="2x"
                    />
                    <h3 className="text-black dark:text-primary_green-0 font-semibold mt-2 text-xs sm:text-sm md:text-md">
                      2.{" "}
                ...
                {totalData[0] !== undefined && (
                  <>
                    ...
                    <FontAwesomeIcon
                      ...
                      size="3x"
                    />
                    <h3 className="text-black dark:text-primary_green-0 font-semibold mt-4 text-xs sm:text-sm md:text-md">
                      1.{" "}
