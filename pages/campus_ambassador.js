  ...
  return (
    <>
      ...
      <div className="items-center justify-center">
        <p className="font-sans text-center text-2xl font-extrabold text-black-100">
          <p className="text-primary_green-0 dark:text-white font-sans text-3xl md:text-5xl text center font-extrabold flex wrap justify-center flex-col md:flex-row mb-10 underline decoration-orange-500  underline-offset-8">
            <h1 className="text-primary_green-0">Campus&nbsp;</h1>
            <h1>Ambassadors </h1>
          </p>
        </p>
      </div>
      ...
      {/* <div className="flex flex-row justify-center flex-wrap items-center gap-5">
        <a>
          <button
            className="bg-gradient-to-b from-primary_green-0 to-orange-600 text-lg text-white dark:text-black font-medium hover:bg-gradient-to-t hover:from-primary_green-0 hover:to-orange-600 text-md text-white font-bold px-10 py-3 rounded md:text-2xl md:py-4 rounded md:text-2xl md:py-6"
            ...
            <>
              {curElem == null ? (
                ...
                <div className="flex items-center justify-center w-60" key={i}>
                  <div className="p-3 justify-center shadow bg-primary_green-0 rounded-xl w-full md:h-fit">
