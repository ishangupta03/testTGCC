                ...
                <div className="flex items-center justify-center w-60" key={i}>
                  <div className="justify-center shadow dark:bg-black text-black dark:text-white rounded-xl w-full overflow-y-clip rounded-lg h-fit md:h-60 shadow-xl dark:shadow-none shadow-slate-400">
                    ...
                    <div className="flex items-center justify-center mb-4 font-semibold px-1 pt-2">
                      <div className="flex justify-center bg-orange-100 dark:bg-gradient-to-b dark:from-primary_green-0 to-orange-600 text-md rounded-lg m-2 h-28">
                        <div className="text-primary_green-0 dark:text-black text-md m-2">
                          {curElem["title"]}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <div className="font-bold text-center text-black md:text-xl w-full">
                        ...
                        <button
                          ref={btnRef} 
                          onClick={onOpen} 
                          className=" bottom-0 bg-gradient-to-b from-primary_green-0 to-orange-600 text-lg text-white dark:text-black font-medium rounded-b-md py-1 hover:bg-gradient-to-t hover:from-primary_green-0 hover:to-orange-600 w-full"
                        > 
                            Read Blog
                        </button>
                        </Link>
